...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  ...
  b({ id: 'high_burn_day', category: 'burned', name: 'High Burn', description: 'A big calorie burn day.', howToEarn: 'Log 500 or more burned calories in a single day.', icon: '🏃', recurring: true, burnBased: true }),
